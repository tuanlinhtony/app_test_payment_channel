...
router.get('/qr_code', async(req,res) => {
    res.render('qr_code', {transactionID: Math.floor(Math.random() * 10000000000000000 + 1)})
})
...
router.get('/pay_out', async(req,res) => {
    res.render('pay_out', {transactionID: Math.floor(Math.random() * 10000000000000000 + 1)})
})
